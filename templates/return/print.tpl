...
<div class="row" style="width: 7cm; margin-left:0.5cm;">
    ...
    <div class="row">
        <div class="col-xs-6">
            <strong >Return No : </strong>{$return_no}
        </div>
        <div class="col-xs-6">
    ...
    <div class="row">
        <div class="col-xs-12">
            {php}print_return_item($_SESSION[return_no]);{/php}
        </div>
    </div>
...
<div>
<a href="return.php?job=must_new" class="no-print btn btn-success">New Return</a>
</div>