			...
			<div>
				<form action="sales_basic_report.php?job=search" method="post" class="search">
					<div class="row">
						...
						<div class="col-lg-1">
							<div class="form-group">
								<input type="text" name="to_date" class="form-control" value="{$to_date}" id="datepicker3"  placeholder="From date"/>
							</div>
						</div>
						<div class="col-lg-1">
							<div class="form-group">
								<input type="text" name="from_date" class="form-control" value="{$from_date}" id="datepicker2"  placeholder="To Date"/>
							</div>
						</div>
						<div class="col-lg-1">
